...
export default function GenerationModal({ generation, isOpen, onClose }) {
  const modalRef = useRef();
  const { runAgain } = useGenerationQueueContext();
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center">
                    <img
                      ...
                      className="w-full h-24 object-cover rounded-md mb-2"
                    />
                    <p className="text-xs text-gray-500">Person Image</p>
                  </div>
                </div>
              </div>
            </div>
